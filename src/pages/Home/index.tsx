        ...
        <Box sx={{ flexGrow: 1 }}>
            <Grid container flexDirection='row-reverse' spacing={5}>
                <Grid item xs={12} sm={2} sx={{mt:5}}>
                    <Button onClick={handleSaveAndLogout} variant='contained' color='warning' size='small'>Sair</Button>
                </Grid>
                <Grid item xs={12} sm={10} sx={{textAlign: 'center', mt:10,}}>
                    <h1>Sistema de Recados {userLogged?.name}</h1>
                </Grid>
            </Grid>
            <Grid container columnSpacing={3} alignItems={'center'} marginY={5} padding={2}>
                <Grid item xs={4} sx={{textAlign: 'center',}}>
                    <InputDefault type='text' label='Descrição' name='description' value={description} color='warning' handleChange={mudarInput}/>
                </Grid>
                <Grid item xs={4}>
                    <InputDefault type='text' label='Detalhamento' name='detail' value={detail} color='warning' handleChange={mudarInput}/>
                </Grid>
                <Grid item xs={4}>
                    <Button variant='contained' color='warning' size='large' onClick={handleSaveRecado}>Salvar</Button>
                </Grid>
            </Grid>
