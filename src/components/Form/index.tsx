                ...
                <Stack sx={{ my: 26, mx: 4, display: 'flex', flexDirection: 'column', alingItems: 'center', }}>
                    ...
                    <Grid container>
                        <Grid sx={{ textAlign: 'center', mt: 2, }}>
                            {mode === 'login' && (<Typography color='white' variant='subtitle2'>Não tem conta? <Typography variant='button' color='warning' sx={{ cursor: 'pointer' }} onClick={handleNavigate}>Cadastre-se</Typography></Typography>)}
                            {mode === 'signup' && (<Typography color='white' variant='subtitle2'>Já tem conta? <Typography variant='button' color='warning' sx={{ cursor: 'pointer' }} onClick={handleNavigate}>Fazer Login</Typography></Typography>)}
                        </Grid>
                    </Grid>
                </Stack>
            </Grid>
